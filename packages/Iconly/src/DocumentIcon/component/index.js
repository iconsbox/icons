...
const DocumentIcon = ({ className, size }) => (
  <svg
    ...
    fill="currentColor"
  >
    <g fill="#200E32" fillRule="nonzero" transform="translate(3 2)">
      <path
        d="M13.191,0 L4.81,0 C1.77,0 0,1.78 0,4.83 L0,15.16 C0,18.26 1.77,20 4.81,20 L13.191,20 C16.28,20 18,18.26 18,15.16 L18,4.83 C18,1.78 16.28,0 13.191,0"
        opacity=".4"
      ></path>
