...
const Chat3Icon = ({ className, size }) => (
  <svg
    data-testid="Chat3Icon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    >
      ...
      <ellipse cx="5.287" cy="10" fill="#200E32" rx="1" ry="1"></ellipse>
      <ellipse cx="10.057" cy="10" fill="#200E32" rx="1" ry="1"></ellipse>
      <ellipse cx="14.826" cy="10" fill="#200E32" rx="1" ry="1"></ellipse>
    </g>
  </svg>
);
...
Chat3Icon.defaultProps = {
  size: 1.5
};

export default Chat3Icon;
