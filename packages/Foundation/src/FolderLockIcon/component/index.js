...
const FolderLockIcon = ({ className, size }) => (
  <svg
    data-testid="FolderLockIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M69.499,52.139c-1.84,0-3.336,1.495-3.336,3.332v2.921h6.672v-2.921c0-0.006,0-0.013,0-0.02h-0.001
		c0-0.004,0.001-0.007,0.001-0.011C72.817,53.617,71.328,52.139,69.499,52.139z"
      ></path>
      <path
        d="M86.016,24.091H49.313c-1.979-2.37-4.013-4.865-4.54-5.624c-0.511-1.071-1.608-1.808-2.874-1.808H27.367
