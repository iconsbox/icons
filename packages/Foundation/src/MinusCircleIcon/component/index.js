...
const MinusCircleIcon = ({ className, size }) => (
  <svg
  ...
  >
    <g>
      <path
        fill="#231F20"
        d="M67.441,44.796H32.559c-0.507,0-0.918,0.411-0.918,0.918v8.572c0,0.507,0.411,0.918,0.918,0.918h34.883
		c0.507,0,0.918-0.411,0.918-0.918v-8.572C68.359,45.207,67.948,44.796,67.441,44.796z"
      ></path>
      <g>
        <path
          fill="#231F20"
          d="M50,22.44c15.196,0,27.56,12.366,27.56,27.562C77.56,65.199,65.196,77.56,50,77.56
