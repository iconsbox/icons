...
const PageRemoveIcon = ({ className, size }) => (
  <svg
    data-testid="PageRemoveIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          d="M75.412,70.658v-0.033h-0.003c-0.018-0.939-0.783-1.696-1.727-1.696h-6.49h0c-0.944,0-1.708,0.757-1.727,1.696h-0.01
      ...
      <g>
        <path
          d="M83.413,53.562h-25.95c-0.956,0-1.73,0.774-1.73,1.73v6.92c0,0.955,0.774,1.73,1.73,1.73h25.95
...
PageRemoveIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

PageRemoveIcon.defaultProps = {
  size: 1.5
};
