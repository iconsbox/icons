...
const AnnotateIcon = ({ className, size }) => (
  <svg
    data-testid="AnnotateIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M82.488,68.439V31.561c3.232-1.769,5.424-5.199,5.424-9.143c0-5.753-4.664-10.417-10.417-10.417
...
AnnotateIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

AnnotateIcon.defaultProps = {
  size: 1.5
};
