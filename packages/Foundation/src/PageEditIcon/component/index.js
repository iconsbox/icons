...
const PageEditIcon = ({ className, size }) => (
  <svg
    data-testid="PageEditIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          d="M67.041,78.553h-6.49h0c-0.956,0-1.73,0.774-1.73,1.73h-0.007v3.01H18.173V36.16h17.723c0.956,0,1.73-0.774,1.73-1.73
      ...
      <g>
        <path
          d="M91.277,39.04L79.656,27.419c-0.676-0.676-1.771-0.676-2.447,0L45.404,59.224l0.069,0.069l-0.109-0.029l-4.351,16.237
...
PageEditIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

PageEditIcon.defaultProps = {
  size: 1.5
};
