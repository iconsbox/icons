...
const SocialFoursquareIcon = ({ className, size }) => (
  <svg
    data-testid="SocialFoursquareIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M36.217,40.748c-0.495-0.498-1.175-0.781-1.878-0.78c-0.698,0.001-1.384,0.281-1.881,0.776l-6.322,6.315
      ...
      ></path>
      <path
        d="M87.348,43.137L54.835,75.666c-1.404,1.389-3.262,2.154-5.24,2.154l-1.443-0.002l-0.304-0.204
...
SocialFoursquareIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SocialFoursquareIcon.defaultProps = {
  size: 1.5
};
