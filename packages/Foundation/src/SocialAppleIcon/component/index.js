...
const SocialAppleIcon = ({ className, size }) => (
  <svg
    data-testid="SocialAppleIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        ...
        clipRule="evenodd"
        fill="#231F20"
        d="M82.047,36.841c-4.124-5.139-9.91-8.112-15.372-8.112
      ...
      <path
        ...
        clipRule="evenodd"
        fill="#231F20"
        d="M61.194,22.988c2.625-3.368,4.619-8.126,3.895-12.988
...
SocialAppleIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SocialAppleIcon.defaultProps = {
  size: 1.5
};
