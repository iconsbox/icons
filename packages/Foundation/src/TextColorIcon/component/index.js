...
const TextColorIcon = ({ className, size }) => (
  <svg
  ...
  >
    <g>
      <path
        d="M84,78.754c-0.035,0-0.068,0.009-0.104,0.01v-0.01h-68v0.01C14.288,78.82,13,80.133,13,81.754s1.288,2.934,2.897,2.99v0.01
		h68v-0.01c0.035,0.001,0.068,0.01,0.104,0.01c1.656,0,3-1.343,3-3S85.656,78.754,84,78.754z"
      ></path>
      <path
        d="M25.371,71.854h5.679c1.138,0,2.096-0.735,2.45-1.754l3.493-9.195h25.97l3.605,9.492l0.021-0.004
