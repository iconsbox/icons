...
const RssIcon = ({ className, size }) => (
  ...
  >
    <g>
      <path
        d="M26.258,64.949c-4.848,0-8.78,3.93-8.78,8.784c0,4.848,3.932,8.782,8.78,8.782c4.855,0,8.784-3.934,8.784-8.782
		C35.042,68.878,31.113,64.949,26.258,64.949z"
      ></path>
      <path
        d="M23.536,40.801c-0.046,0-0.09,0.006-0.135,0.007v-0.007h-3.464v0.039c-1.698,0.193-3.021,1.603-3.056,3.344h-0.007v6.159
      ...
      ></path>
      <path
        d="M83.119,76.403C82.98,43.664,56.308,17.07,23.536,17.07c-0.046,0-0.09,0.006-0.135,0.007V17.07h-3.464v0.039
