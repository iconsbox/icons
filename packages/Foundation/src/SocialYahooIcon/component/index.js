...
const SocialYahooIcon = ({ className, size }) => (
  <svg
    data-testid="SocialYahooIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      ...
      <polygon
        ...
        clipRule="evenodd"
        fill="#231F20"
        points="100,23.438 82.519,21.283 82.631,61.805 90.238,62.824
		100,23.438 	"
      ></polygon>
      <g>
        <g>
          <path
            ...
            clipRule="evenodd"
            fill="#231F20"
            d="M64.813,30.477c-7.038-5.336-16.118-7.941-27.13-7.941
...
SocialYahooIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SocialYahooIcon.defaultProps = {
  size: 1.5
};
