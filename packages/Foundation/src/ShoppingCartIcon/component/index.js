...
const ShoppingCartIcon = ({ className, size }) => (
  ...
  >
    <g>
      <circle cx="32.961" cy="81.02" r="5.889"></circle>
      <circle cx="74.309" cy="81.02" r="5.889"></circle>
      <path
        d="M73.513,55.216c1.377,0,2.556-0.812,3.11-1.978l0.003,0.002l14.589-25.27l-0.018-0.01c0.214-0.449,0.344-0.946,0.344-1.477
