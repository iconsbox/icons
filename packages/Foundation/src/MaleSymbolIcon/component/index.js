...
const MaleSymbolIcon = ({ className, size }) => (
  <svg
    data-testid="MaleSymbolIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          fill="#231F20"
          d="M83.417,18.329c0-0.002,0.001-0.003,0.001-0.005c0-0.853-0.69-1.544-1.542-1.545v-0.016H61.078v0.017
...
MaleSymbolIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

MaleSymbolIcon.defaultProps = {
  size: 1.5
};
