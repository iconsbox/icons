...
const ArrowsExpandIcon = ({ className, size }) => (
  <svg
    data-testid="ArrowsExpandIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          d="M5.128,67.194L0.024,97.962c-0.093,0.558,0.09,1.125,0.489,1.524c0.002,0.003,0.002,0.003,0.002,0.003
      ...
      <g>
        <path
          d="M94.872,32.806l5.104-30.768c0.093-0.558-0.09-1.125-0.489-1.524c-0.002-0.003-0.002-0.003-0.002-0.003
...
ArrowsExpandIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

ArrowsExpandIcon.defaultProps = {
  size: 1.5
};
