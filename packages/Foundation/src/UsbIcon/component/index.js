...
const UsbIcon = ({ className, size }) => (
  ...
  >
    <g>
      <path
        d="M64.603,35.504c-0.032-1.506-1.259-2.719-2.774-2.72c-0.047,0-0.091,0.012-0.138,0.014h-2.039V17.776h0l0-0.002
      ...
      ></path>
      <rect x="47.506" y="27.933" width="4.988" height="2.072"></rect>
    </g>
  </svg>
);
