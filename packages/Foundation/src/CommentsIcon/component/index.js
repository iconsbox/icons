...
const CommentsIcon = ({ className, size }) => (
  <svg
  ...
  >
    <g>
      <path
        d="M94.974,17.838c-0.127-1.257-1.16-2.241-2.443-2.277v-0.007H39.624c-1.315,0-2.384,1.004-2.513,2.284h-0.026v13.139h22.342
      ...
      ></path>
      <path
        d="M54.44,35.964H7.204v0.006c-1.144,0.031-2.067,0.91-2.181,2.033H5v37.835h0.046c0.205,1.015,1.09,1.779,2.158,1.809v0.006
