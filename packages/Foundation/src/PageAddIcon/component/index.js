...
const PageAddIcon = ({ className, size }) => (
  <svg
    data-testid="PageAddIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          d="M73.682,78.553h-6.49h0c-0.956,0-1.73,0.774-1.73,1.73h-0.007v3.01H24.814V36.16h17.723c0.956,0,1.73-0.774,1.73-1.73
      ...
      <g>
        <path
          d="M83.413,53.562h-7.785v-7.785c0-0.955-0.774-1.73-1.73-1.73h-6.92c-0.956,0-1.73,0.775-1.73,1.73v7.785h-7.785
...
PageAddIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

PageAddIcon.defaultProps = {
  size: 1.5
};
