...
const SafetyConeIcon = ({ className, size }) => (
  <svg
    data-testid="SafetyConeIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        fill="#231F20"
        d="M97.017,82.01v-4.62h-0.002l0.002-0.018c-0.01-1.335-1.092-2.407-2.42-2.417v-0.003h-7.512L54.048,17.732
...
SafetyConeIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SafetyConeIcon.defaultProps = {
  size: 1.5
};

export default SafetyConeIcon;
