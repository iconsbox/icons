...
const UploadCloudIcon = ({ className, size }) => (
  <svg
    data-testid="UploadCloudIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <g>
        <path
          d="M79.437,36.831c-3.51-12.982-14.464-22.083-27.134-22.083c-8.835,0-17.065,4.454-22.414,12.018
      ...
      <g>
        <path
          d="M57.345,70.33l-9.918-13.861c-0.179-0.25-0.472-0.4-0.779-0.4h-0.002c-0.31,0-0.598,0.15-0.779,0.404L36.013,70.33
