...
const PagelledIcon = ({ className, size }) => (
  ...
  >
    <g>
      <path
        d="M21.455,36.16h25.95c0.956,0,1.729-0.774,1.729-1.73V8.48c0-0.956-0.774-1.73-1.729-1.73h-1.73L19.725,32.7v1.729
		C19.725,35.386,20.499,36.16,21.455,36.16z"
      ></path>
      <path
        d="M78.545,6.75H60.821c-0.806,0-1.476,0.553-1.669,1.298h-0.061v36.551h-0.002c0,0.008,0.002,0.015,0.002,0.023
