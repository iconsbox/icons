...
const CreditCardIcon = ({ className, size }) => (
  ...
  >
    <g>
      <path
        d="M86.941,26.224c0-1.469-1.191-2.659-2.66-2.659c-0.036,0-0.07,0.009-0.106,0.011H15.949
      ...
      ></path>
      <path
        d="M13.095,73.78L13.095,73.78c0.001,0.003,0,0.006,0,0.01c0,1.468,1.191,2.658,2.659,2.658c0.056,0,0.109-0.013,0.164-0.017
