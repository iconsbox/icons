...
const FolderAddIcon = ({ className, size }) => (
  <svg
    data-testid="FolderAddIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M86.016,24.091H49.313c-1.979-2.37-4.013-4.865-4.541-5.624c-0.511-1.071-1.607-1.808-2.875-1.808H27.367
...
FolderAddIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

FolderAddIcon.defaultProps = {
  size: 1.5
};
