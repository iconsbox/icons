...
const SocialPinterestIcon = ({ className, size }) => (
  <svg
    data-testid="SocialPinterestIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M50.001,10.999C28.464,10.999,11,28.461,11,50c0,15.97,9.603,29.688,23.345,35.72c-0.11-2.723-0.021-5.994,0.679-8.953
...
SocialPinterestIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SocialPinterestIcon.defaultProps = {
  size: 1.5
};
