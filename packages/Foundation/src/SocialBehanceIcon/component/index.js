...
const SocialBehanceIcon = ({ className, size }) => (
  ...
  >
    <g>
      <path
        fill="#231F20"
        d="M64.165,56.231c-3.279,0-4.361,2.494-4.69,3.652h8.754c-0.082-0.643-0.339-1.773-1.157-2.597
		C66.375,56.587,65.4,56.231,64.165,56.231z"
      ></path>
      <path
        fill="#231F20"
        d="M41.662,60.889c-0.003,0-0.003,0-0.003,0H33.37v7.067h7.839c1.398-0.035,3.13-0.485,3.13-3.422
		C44.339,60.991,41.936,60.889,41.662,60.889z"
      ></path>
      <path
        fill="#231F20"
        d="M79.035,14.073h-58c-3.151,0-5.815,2.083-6.693,4.946v62.107c0.741,2.419,2.757,4.28,5.265,4.8h60.855
      ...
      <path
        fill="#231F20"
        d="M43.29,52.132c0-2.609-1.565-2.639-1.63-2.639h-1.135H33.37v5.734h7.742
