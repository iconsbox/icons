...
const PreviousIcon = ({ className, size }) => (
  <svg
    data-testid="PreviousIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M87.06,26.291c-0.483,0-0.918,0.2-1.23,0.521L57.41,43.22V28.009c0-0.949-0.769-1.718-1.718-1.718
