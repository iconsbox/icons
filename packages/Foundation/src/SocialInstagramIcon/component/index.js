...
const SocialInstagramIcon = ({ className, size }) => (
  <svg
    data-testid="SocialInstagramIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        fill="#231F20"
        d="M67.961,45.288c0,9.919-8.041,17.96-17.96,17.96c-9.919,0-17.96-8.041-17.96-17.96
      ...
      <path
        fill="#231F20"
        d="M79,13.5H21c-3.85,0-7,3.15-7,7v14h21.665c3.278-4.349,8.47-7.172,14.335-7.172s11.057,2.823,14.335,7.172
      ...
      <path
        fill="#231F20"
        d="M50.001,61.148c8.736,0,15.818-7.085,15.818-15.819c0-8.735-7.081-15.82-15.818-15.82
...
SocialInstagramIcon.defaultProps = {
  size: 1.5
};
