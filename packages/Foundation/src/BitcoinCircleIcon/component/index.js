...
const BitcoinCircleIcon = ({ className, size }) => (
  ...
  >
    <g id="g99">
      <path
        fill="#231F20"
        d="M49.805,38.076l-2.049,8.215c2.323,0.579,9.483,2.941,10.643-1.708
		C59.608,39.736,52.128,38.655,49.805,38.076z"
      ></path>
      <path
        fill="#231F20"
        d="M46.723,50.437l-2.26,9.058c2.789,0.693,11.392,3.455,12.664-1.655
		C58.456,52.512,49.512,51.133,46.723,50.437z"
      ></path>
      <path
        fill="#231F20"
        d="M59.067,13.621C38.981,8.612,18.633,20.84,13.626,40.932c-5.011,20.089,7.216,40.438,27.3,45.447
