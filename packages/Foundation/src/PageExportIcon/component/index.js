...
const PageExportIcon = ({ className, size }) => (
  <svg
    data-testid="PageExportIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g>
      <path
        d="M94.284,65.553L75.825,52.411c-0.389-0.276-0.887-0.312-1.312-0.093c-0.424,0.218-0.684,0.694-0.685,1.173l0.009,6.221
      ...
      ></path>
      <path
        d="M64.06,78.553h-6.49h0c-0.956,0-1.73,0.774-1.73,1.73h-0.007v3.01H15.191V36.16h17.723c0.956,0,1.73-0.774,1.73-1.73
...
PageExportIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

PageExportIcon.defaultProps = {
  size: 1.5
};

export default PageExportIcon;
