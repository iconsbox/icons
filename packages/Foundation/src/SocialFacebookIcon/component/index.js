...
const SocialFacebookIcon = ({ className, size }) => (
  <svg
    data-testid="SocialFacebookIcon"
    viewBox="0 0 100 100"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    <g id="White_1_">
      <path
        d="M82.026,14H17.974C15.779,14,14,15.779,14,17.974v64.053C14,84.221,15.779,86,17.974,86h34.483V58.118h-9.383V47.252h9.383
