...
const WomansIcon = ({ className, size }) => (
  ...
  >
    ...
    >
      ...
      ></path>
      <circle fill="none" cx="33.547" cy="12.95" r=".075"></circle>
      <path
        fill="none"
        d="M31.874 23.053c0-.511 0-.637-.04-1.458m-8.215-9.639c.404-.779.715-1.079.715-1.079l.728-2.052c2.163 2.325 6.771 2.328 6.771 2.328 5.715-.418 7.522-2.328 7.522-2.328l.477 1.91c.209.401.4.813.572 1.23-.758 1.463-3.932 2.299-6.206 2.72a31.724 31.724 0 01-2.407.357c-2.116-.17-3.688-.485-4.854-.852-3.014-.945-3.318-2.234-3.318-2.234z"
      ></path>
      <path
        fill="none"
        d="M34.198 14.686c-1.366.254-2.364.346-2.364.346 0 1.534.021 4.319 0 6.563 3.835 0 2.364-6.909 2.364-6.909zm-2.364-3.539v3.884"
      ></path>
      <path
        fill="#60A8A6"
        d="M26.938 14.191c-3.015-.946-3.319-2.235-3.319-2.235l.01-.019c-.574 1.103-1.343 3.18-1.678 6.765 4.483 1.68 4.988-4.511 4.987-4.511zm9.939-.139c3.066-.934 3.527-2.086 3.527-2.086l-.01-.021c.573 1.102 1.222 3.099 1.504 6.801-4.482 1.677-5.021-4.694-5.021-4.694z"
      ></path>
    </g>
  </svg>
);
