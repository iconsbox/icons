...
const Womans8Icon = ({ className, size }) => (
  ...
  >
    ...
    >
      ...
      <path
        fill="none"
        d="M36.818 19.41l2.765-1.476s1.981-10.859-.06-10.438c-2.039.422-2.602 3.346-2.771 11.76l.066.154zm-11.855-.157l-2.772-1.311s-2.04-10.867.004-10.446c2.039.422 2.6 3.346 2.769 11.76l-.001-.003z"
      ></path>
    </g>
  </svg>
);
