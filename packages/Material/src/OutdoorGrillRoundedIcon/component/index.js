...
const OutdoorGrillRoundedIcon = ({ className, size }) => (
  <svg
    data-testid="OutdoorGrillRoundedIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
