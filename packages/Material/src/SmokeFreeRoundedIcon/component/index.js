...
const SmokeFreeRoundedIcon = ({ className, size }) => (
  <svg
    data-testid="SmokeFreeRoundedIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
