...
const SportsRoundedIcon = ({ className, size }) => (
  <svg
    data-testid="SportsRoundedIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
