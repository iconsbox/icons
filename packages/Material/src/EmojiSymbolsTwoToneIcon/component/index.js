...
const EmojiSymbolsTwoToneIcon = ({ className, size }) => (
  <svg
    data-testid="EmojiSymbolsTwoToneIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
