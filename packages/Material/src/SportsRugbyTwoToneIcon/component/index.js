...
const SportsRugbyTwoToneIcon = ({ className, size }) => (
  <svg
    data-testid="SportsRugbyTwoToneIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
...
SportsRugbyTwoToneIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SportsRugbyTwoToneIcon.defaultProps = {
  size: 1.5
};

export default SportsRugbyTwoToneIcon;
