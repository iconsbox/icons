...
const SpeakerPhoneRoundedIcon = ({ className, size }) => (
  <svg
    data-testid="SpeakerPhoneRoundedIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
