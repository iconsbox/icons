...
const FireplaceTwoToneIcon = ({ className, size }) => (
  <svg
    data-testid="FireplaceTwoToneIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
...
FireplaceTwoToneIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

FireplaceTwoToneIcon.defaultProps = {
  size: 1.5
};

export default FireplaceTwoToneIcon;
