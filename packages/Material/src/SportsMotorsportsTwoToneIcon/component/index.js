...
const SportsMotorsportsTwoToneIcon = ({ className, size }) => (
  <svg
    data-testid="SportsMotorsportsTwoToneIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
...
SportsMotorsportsTwoToneIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

SportsMotorsportsTwoToneIcon.defaultProps = {
  size: 1.5
};

export default SportsMotorsportsTwoToneIcon;
