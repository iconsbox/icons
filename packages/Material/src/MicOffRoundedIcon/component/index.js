...
const MicOffRoundedIcon = ({ className, size }) => (
  <svg
    data-testid="MicOffRoundedIcon"
    viewBox="0 0 24 24"
    className={className}
    style={{
      width: size * 10,
