...
const CallIcon = ({ className, size }) => (
  ...
  >
    <path
      fill="#a3d86b"
      d="M20.7 8.2l-2.1-2.1c-.4-.4-1-.4-1.4 0-.4.4-.4 1 0 1.4l.4.4h-4.2c-.6 0-1 .4-1 1s.4 1 1 1h4.2l-.4.4c-.4.4-.4 1 0 1.4.4.4 1 .4 1.4 0l2.1-2.1c.4-.4.4-1 0-1.4z"
    ></path>
    <path
      fill="#ff9e68"
      d="M19.6 15.6l2.1 2.1c.4.4 1 .4 1.4 0 .4-.4.4-1 0-1.4l-.4-.4H27c.6 0 1-.4 1-1s-.4-1-1-1h-4.2l.4-.4c.4-.4.4-1 0-1.4-.4-.4-1-.4-1.4 0l-2.1 2.1c-.4.4-.4 1-.1 1.4z"
    ></path>
    <path
      fill="#67acd5"
      d="M22.4 21.7l-2.2-2.2c-.3-.3-.9-.4-1.3-.1l-2.2 1.5c-.8.5-1.8.4-2.5-.2l-5.5-5.5c-.7-.7-.8-1.7-.2-2.5l1.5-2.2c.3-.4.2-.9-.1-1.3L7.5 6.9c-.4-.4-1-.4-1.4 0L4.2 8.8c-1 1-1.4 2.4-1.1 3.8.6 2.3 1.7 4.3 3.4 6l4.1 4.1c1.7 1.7 3.7 2.8 6 3.4 1.4.3 2.8-.1 3.8-1.1l1.9-1.9c.5-.4.5-1 .1-1.4z"
    ></path>
    <path
      fill="#5791d1"
      d="M20.9 24.6l1.5-1.5c.4-.4.4-1 0-1.4l-2.2-2.2c-.3-.3-.9-.4-1.3-.1L17 20.6l3.9 4zM8.6 12.3l1.3-1.9c.3-.4.2-.9-.1-1.3L7.5 6.9c-.4-.4-1-.4-1.4 0L4.7 8.3l3.9 4z"
    ></path>
    <path
      fill="#40455a"
