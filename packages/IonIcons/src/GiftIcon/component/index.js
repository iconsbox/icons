...
const GiftIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M200,144h40V104a40,40,0,1,0-40,40Z" style="fill:none"></path>
    <path
      d="M352,104a40,40,0,0,0-80,0v40h40A40,40,0,0,0,352,104Z"
      style="fill:none"
    ></path>
    <path d="M80,416a64,64,0,0,0,64,64h92a4,4,0,0,0,4-4V292a4,4,0,0,0-4-4H88a8,8,0,0,0-8,8Z"></path>
    ...
    <path d="M276,480h92a64,64,0,0,0,64-64V296a8,8,0,0,0-8-8H276a4,4,0,0,0-4,4V476A4,4,0,0,0,276,480Z"></path>
  </svg>
);
