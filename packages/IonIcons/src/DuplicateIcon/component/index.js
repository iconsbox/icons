...
const DuplicateIcon = ({ className, size }) => (
  <svg
  ...
  >
    ...
    <path d="M395.88,80A72.12,72.12,0,0,0,328,32H104a72,72,0,0,0-72,72V328a72.12,72.12,0,0,0,48,67.88V160a80,80,0,0,1,80-80Z"></path>
  </svg>
);
