...
const CloudDownloadIcon = ({ className, size }) => (
  <svg
  ...
  >
    ...
    <path d="M240,425.42l-36.7-36.64a16,16,0,0,0-22.6,22.65l64,63.89a16,16,0,0,0,22.6,0l64-63.89a16,16,0,0,0-22.6-22.65L272,425.42V352H240Z"></path>
  </svg>
);

CloudDownloadIcon.propTypes = {
