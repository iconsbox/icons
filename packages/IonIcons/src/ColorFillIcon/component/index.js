...
const ColorFillIcon = ({ className, size }) => (
  <svg
    data-testid="ColorFillIcon"
    viewBox="0 0 512 512"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M416,480c-35.29,0-64-29.11-64-64.88,0-33.29,28.67-65.4,44.08-82.64,1.87-2.1,3.49-3.91,4.68-5.31a19.94,19.94,0,0,1,30.55,0c1.13,1.31,2.63,3,4.36,4.93,15.5,17.3,44.33,49.51,44.33,83.05C480,450.89,451.29,480,416,480Z"></path>
