...
const PartlySunnySharpIcon = ({ className, size }) => (
  ...
  >
    ...
    <path d="M381.5,219.89a169.23,169.23,0,0,1,45.44,19A96,96,0,0,0,281,129.33q-2.85,2-5.54,4.2a162.47,162.47,0,0,1,57.73,28.23A174.53,174.53,0,0,1,381.5,219.89Z"></path>
    <rect x="448" y="192" width="64" height="32"></rect>
    <rect x="320" y="32" width="32" height="64"></rect>
    <path d="M255.35,129.63l12.45-12.45L223.18,72.55,200.55,95.18l33.17,33.17h.6A172,172,0,0,1,255.35,129.63Z"></path>
    <rect
      x="406.27"
      y="90.18"
      width="63.11"
