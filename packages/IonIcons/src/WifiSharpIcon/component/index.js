...
const WifiSharpIcon = ({ className, size }) => (
  ...
  >
    ...
    <path
      ...
      style="fill:none;stroke:#000;strokeLinecap:square;strokeLinejoin:round;strokeWidth:42px"
    ></path>
    <path
    ...
    <path
      ...
      style="fill:none;stroke:#000;strokeLinecap:square;strokeLinejoin:round;strokeWidth:42px"
    ></path>
    <path d="M300.67,384,256,433l-44.34-49a56.73,56.73,0,0,1,88.92,0Z"></path>
  </svg>
);
