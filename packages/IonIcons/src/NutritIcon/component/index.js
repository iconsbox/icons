...
const NutritIcon = ({ className, size }) => (
  <svg
    data-testid="NutritIcon"
    viewBox="0 0 512 512"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M265.1,111.93c13.16-1.75,37.86-7.83,58.83-28.79a98,98,0,0,0,28-58.2A8,8,0,0,0,343.38,16c-12.71.95-36.76,5.87-58.73,27.85A97.6,97.6,0,0,0,256,103.2,8,8,0,0,0,265.1,111.93Z"></path>
  </svg>
);

NutritIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

NutritIcon.defaultProps = {
  size: 1.5
};

export default NutritIcon;
