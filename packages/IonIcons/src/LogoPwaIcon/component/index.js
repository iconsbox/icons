...
const LogoPwaIcon = ({ className, size }) => (
  <svg
    data-testid="LogoPwaIcon"
    viewBox="0 0 512 512"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M330.7,352l77.72-192H356.9L303.74,284.07,265.93,160H226.32L185.74,284.07l-28.63-56.53L131.21,307l26.3,45h50.7l36.68-111.27,35,111.27Z"></path>
...
LogoPwaIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

LogoPwaIcon.defaultProps = {
  size: 1.5
};

export default LogoPwaIcon;
