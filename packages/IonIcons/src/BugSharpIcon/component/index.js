...
const BugSharpIcon = ({ className, size }) => (
  <svg
    data-testid="BugSharpIcon"
    viewBox="0 0 512 512"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M256,32c-48.06,0-96,0-96,84,26.12-14,59.35-20,96-20,24.09,0,46.09,2.65,65.39,8,10.75,3,24.66,8.71,30.61,12C352,32,304.06,32,256,32Z"></path>
  </svg>
);

BugSharpIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

BugSharpIcon.defaultProps = {
  size: 1.5
};

export default BugSharpIcon;
