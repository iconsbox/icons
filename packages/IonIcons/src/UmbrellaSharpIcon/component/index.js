...
const UmbrellaSharpIcon = ({ className, size }) => (
  <svg
    data-testid="UmbrellaSharpIcon"
    viewBox="0 0 512 512"
    className={className}
    style={{
      width: size * 10,
  ...
  >
    ...
    <path d="M128.93,280l-.26-.3c-.9-.74-1.83-1.43-2.77-2.1Z"></path>
    <path d="M383.08,280l2.62-2.12c-.79.58-1.57,1.17-2.34,1.79Z"></path>
...
UmbrellaSharpIcon.propTypes = {
  className: PropTypes.string,
  size: PropTypes.number
};

UmbrellaSharpIcon.defaultProps = {
  size: 1.5
};

export default UmbrellaSharpIcon;
